...
:class:`africas2s.Index`), then evaluate it at the forecast-year index value to
...
forecast primitive whose predictor is a 1-D index series.
    ...
    idx = africas2s.Index.named("wvg")
    p = africas2s.logistic_forecast(idx.reduce(sst_hcst), obs, idx_fcst)
