...
def calibrate(predictor=None, obs=None, *, method, forecast=None,
    ...
    return_components : bool
        ...
        :func:`africas2s.combine_terciles`) without refitting.
    cv : {None, "loyo"}
        ...
        leading ``year`` dimension and is ready for :func:`africas2s.skill`.
...
class CalibrateResult:
    ...
    :func:`africas2s.combine_terciles` without refitting anything.
...
def _native_obs_hindcast_years(hcst, obs, *, name):
    ...
    ``calibrate_ereg_native_years`` (rosetta_africas2s.run_pipeline), which
